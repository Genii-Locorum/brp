...
export class BRPProfessionSheet extends ItemSheet {
  ...
  async getData () {
    ...
    sheetData.minWealthOptions = await BRPCharGen.getWealthOptions(0,4)
    sheetData.maxWealthOptions = await BRPCharGen.getWealthOptions(itemData.system.minWealth,4)
